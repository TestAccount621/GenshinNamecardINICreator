...
* Fontaine: Redemption - This one has slightly different dimensions, 843 pixels vs the standard 840 pixels wide, so I just didn't add it to the list since I would have to hard code in the hash that can change in the future for a special case.
